...
const Achievement = () => {
    ...
    const achievementData = [
        { id: 1, type: "acheivement", link: "/pdf/pdf1.pdf" }
    ];
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-[#1a202c] text-white">
                                            ...
                                            <th className="px-6 py-4 font-bold border-r border-gray-700">Achievements Type</th>
                                            <th className="px-6 py-4 font-bold text-center">Achievements Pdf</th>
                                        </tr>
                                    </thead>
