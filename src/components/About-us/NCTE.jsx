...
import { ncteHero } from "../common/data/heroData";
    ...
    const documents = [
        {
            ...
            description: "Official recognition document from NCTE for the B.Ed. course.",
            pdfPath: "/pdf/brochure.pdf"
        },
        {
            id: 2,
            title: "Revise Order",
            description: "Updated and revised orders from NCTE regarding institutional norms.",
            pdfPath: "/pdf/brochure.pdf" // Using same PDF as requested
        }
    ];
                    ...
                    >
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-black text-[#0b2c4d] mb-4">
                                NCTE Recognition & Revise Order
                            </h2>
                            <p className="text-gray-600 max-w-2xl mx-auto text-lg font-medium">
                                Access official documentation and recognition certificates issued by the National Council for Teacher Education.
                            </p>
